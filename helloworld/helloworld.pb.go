...
func (c *greeterClient) SayGoodbye(ctx context.Context, in *GoodbyeRequest, opts ...grpc.CallOption) (*GoodbyeReply, error) {
	...
	err := grpc.Invoke(ctx, "/helloworld.Greeter/SayGoodbye", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	0x24, 0xa1, 0x87, 0xe4, 0x25, 0x64, 0xd7, 0x4b, 0x89, 0x61, 0x91, 0x01, 0xda, 0xa1, 0xc4, 0x20,
	0xe4, 0xc2, 0xc5, 0x05, 0xd4, 0x0f, 0xb5, 0x58, 0x48, 0x0a, 0x59, 0x1d, 0xaa, 0x9b, 0xa5, 0x24,
	0xb0, 0xca, 0x81, 0x4d, 0x71, 0x32, 0xe0, 0x92, 0xce, 0xcc, 0xd7, 0x4b, 0x2f, 0x2a, 0x48, 0xd6,
	0x4b, 0xad, 0x48, 0xcc, 0x2d, 0xc8, 0x49, 0x2d, 0x46, 0x52, 0xed, 0xc4, 0x0f, 0xb6, 0x32, 0x1c,
	0xc4, 0x0e, 0x00, 0x85, 0x74, 0x00, 0x63, 0x12, 0x1b, 0x38, 0xc8, 0x8d, 0x01, 0x01, 0x00, 0x00,
	0xff, 0xff, 0x09, 0xe7, 0x16, 0x99, 0x86, 0x01, 0x00, 0x00,
}
